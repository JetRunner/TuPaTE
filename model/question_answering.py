...
from .lora_bert import BertPreTrainedModel as LoraBertPreTrainedModel, BertModel as LoraBertModel
...
class BitfitBertForQuestionAnswering(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        print(f"# Trainable parameters: {trainable_cnt}")
...
class LoraBertForQuestionAnswering(LoraBertPreTrainedModel):
...
class BertPromptForQuestionAnswering(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
...
class RobertaPromptModelForQuestionAnswering(RobertaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
