...
_URLS = {
    "train": _URL + "DuoRC_Paraphrase_train.json.gz",
    "dev": _URL + "DuoRC_Paraphrase_dev.json.gz",
}
...
class SquadV2(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        SquadV2Config(name="duorcp", version=datasets.Version("2.0.0"), description="SQuAD plaint text version 2"),
    ]
