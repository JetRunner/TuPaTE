...
_URLS = {
    "train": _URL + "ComQA_train.json.gz",
    "dev": _URL + "ComQA_dev.json.gz",
}
...
class SquadV2(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        SquadV2Config(name="comqa", version=datasets.Version("2.0.0"), description="SQuAD plaint text version 2"),
    ]
