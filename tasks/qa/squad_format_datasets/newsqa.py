...
_URLS = {
    "train": _URL + "NewsQA_train.json.gz",
    "dev": _URL + "NewsQA_dev.json.gz",
}
...
class SquadV2(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        SquadV2Config(name="newsqa", version=datasets.Version("2.0.0"), description="SQuAD plaint text version 2"),
    ]
