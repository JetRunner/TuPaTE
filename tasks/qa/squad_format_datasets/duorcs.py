...
_URLS = {
    "train": _URL + "DuoRC_Self_train.json.gz",
    "dev": _URL + "DuoRC_Self_dev.json.gz",
}
...
class SquadV2(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        SquadV2Config(name="duorcs", version=datasets.Version("2.0.0"), description="SQuAD plaint text version 2"),
    ]
