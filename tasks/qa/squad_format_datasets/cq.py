...
_URLS = {
    "train": _URL + "ComplexQuestions_train.json.gz",
    "dev": _URL + "ComplexQuestions_dev.json.gz",
}
...
class SquadV2(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        SquadV2Config(name="cq", version=datasets.Version("2.0.0"), description="SQuAD plaint text version 2"),
    ]
