...
_URLS = {
    "train": _URL + "WikiHop_train.json.gz",
    "dev": _URL + "WikiHop_dev.json.gz",
}
...
class SquadV2(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        SquadV2Config(name="wikihop", version=datasets.Version("2.0.0"), description="SQuAD plaint text version 2"),
    ]
