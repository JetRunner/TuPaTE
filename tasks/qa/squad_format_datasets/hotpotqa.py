...
_URLS = {
    "train": _URL + "HotpotQA_train.json.gz",
    "dev": _URL + "HotpotQA_dev.json.gz",
}
...
class SquadV2(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        SquadV2Config(name="hotpotqa", version=datasets.Version("2.0.0"), description="SQuAD plaint text version 2"),
    ]
